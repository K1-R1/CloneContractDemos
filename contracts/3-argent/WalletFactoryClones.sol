...
contract WalletFactoryClones is ManagedV2 {
     ...
     */
    function revokeManager(address _manager) external override {
    ...
    function configureWallet(
        ...
        // add guardian
        IGuardianStorage(guardianStorage).addGuardian(
            address(_wallet),
            _guardian
        );
